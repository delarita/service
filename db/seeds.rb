...
Epilation.create(description: "", category: "homme", name: "Bras", price_cents:2000, user_id:1)
Epilation.create(description: "", category: "homme", name: "Jambes", price_cents:3000, user_id:1)

Epilation.create(description: "", category: "femme", name: "Lèvres, sourcils", price_cents:700, user_id:1)
Epilation.create(description: "", category: "femme", name: "Structuration des sourcils", price_cents:1300, user_id:1)
Epilation.create(description: "", category: "femme", name: "Aisselles", price_cents:1000, user_id:1)
Epilation.create(description: "", category: "femme", name: "Bras", price_cents:1500, user_id:1)
Epilation.create(description: "", category: "femme", name: "Maillot échancré", price_cents:1500, user_id:1)
Epilation.create(description: "", category: "femme", name: "Maillot intégral", price_cents:2200, user_id:1)
Epilation.create(description: "", category: "femme", name: "1/2 jambe", price_cents:1500, user_id:1)
Epilation.create(description: "", category: "femme", name: "Jambes", price_cents:2400, user_id:1)
Epilation.create(description: "", category: "femme", name: "Forfait lèvres ~ sourcils ~ aisselles ~ maillot échancré ~ 1/2 jambes", price_cents:4000, user_id:1)
...
Massage.create(description: "", name: "Massage spécifique du dos: 30 mn", price_cents:3000, user_id:1)
Massage.create(description: "", name: "Massage spécifique des pieds: 30 mn", price_cents:3000, user_id:1)
...
Soinvisage.create(description: "", category: "Soins Esthétiques", name: "Soin spécifique des pieds", price_cents:3500, user_id:1)
Soinvisage.create(description: "", category: "Soins Esthétiques", name: "Pose vernis", price_cents:800, user_id:1)
...
Maquillage.create(description: "", name: "Eye liner supérieur", price_cents:21000, user_id:1)
Maquillage.create(description: "", name: "Eye liner inférieur", price_cents:17000, user_id:1)
