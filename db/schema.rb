...
ActiveRecord::Schema.define(version: 2021_02_09_093604) do
  ...
  create_table "epilations", force: :cascade do |t|
    t.string "name"
    t.text "description"
  ...
  create_table "maquillages", force: :cascade do |t|
    t.string "name"
    t.text "description"
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "order_items", force: :cascade do |t|
    ...
    t.index ["order_id", "orderitemable_type", "orderitemable_id"], name: "uniq_order_index", unique: true
  ...
  add_foreign_key "epilations", "users"
